...
export const RoleBasedHeader = () => {
  ...
  if (user?.role === UserRole.teacher) {
    return (
      <header className="sticky top-0 z-40 border-b bg-navbar px-4 md:px-6 py-4 backdrop-blur-sm">
  ...
  return (
    <header className="sticky top-0 z-40 flex h-14 items-center gap-4 border-b bg-navbar px-4 md:px-6 backdrop-blur-sm">
